...
[![Version](https://img.shields.io/badge/version-0.3.2--beta-blue.svg?style=flat-square)](https://github.com/iharshraj1123/Gitero-IDE/releases)
...
1. Download the latest installer `Gitero-Setup-0.3.2-beta.exe` from [Releases](https://github.com/iharshraj1123/Gitero-IDE/releases).
